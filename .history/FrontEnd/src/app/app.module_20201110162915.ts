...
import { AddCompteComponent } from './user/profil/add-compte/add-compte.component';
...
@NgModule({
  ...
  entryComponents :[ConfirmDialogComponent,AbonnementComponent,ImagezoomComponent,AddCompteComponent]
})
