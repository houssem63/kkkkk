...
console.log(this.formbanque.form.status, this.formbanque.form.dirty, this.formbanque.form.pristine,
  this.formbanque.form.untouched, this.formbanque.submitted, this.formbanque.dirty, this.formbanque.pristine, this.formbanque.untouched);

    // This is the key!
    this.formbanque.resetForm();

    console.log(this.formbanque.form.status, this.formbanque.form.dirty, this.formbanque.form.pristine, this.formbanque.form.untouched, this.formbanque.submitted, this.formbanque.dirty, this.formbanque.pristine, this.formbanque.untouched);

this.formbanque.updateValueAndValidity();this.myDrop.close();
