...
import { ModeDePaimentComponent } from './mode-de-paiment/mode-de-paiment.component';
...
const routes: Routes = [
...

  {
    ...
    children: [
      ...
      {path : 'personnel', component : ListUserComponent , data: {
        role: 'Personnel',
      }},

      {path : 'client', component : ListUserComponent, data: {
        role: 'Client',
...
{path:'liste_vehicule',  component: VehiculeComponent},
{path:'edit',component:EditVehiculeComponent},
{path:'edit/:id',component:EditVehiculeComponent}
,
{path:'assurance/:id',component:AssuranceComponent}
    ...
    {path : 'mode_paiement', component : ModeDePaimentComponent},
