...
public  Userfunction = 'Société';
  ...
  constructor(private userService: UserService, private abonnentservice: AbonnementService,
              private roleservices: RoleService, public loginservice: LoginService, public dialog: MatDialog,
...
if (this.route.snapshot.paramMap.get('role')==='null'){
    ...
    if (this.route.snapshot.paramMap.get('role')!=='null') {
      ...
      if (this.route.snapshot.paramMap.get('role') === 'Personnel') {
        this.changeform('formpersonnel',this.route.snapshot.paramMap.get('role'))
      } else {
        this.changeform('formclient',this.route.snapshot.paramMap.get('role'))
  ...
  changeform(formname, userfuction) {
    ...
    this.roleservices.getRolesub().subscribe((res => {
      ...
      const roledebut = roles.find(r => r.Libelle === userfuction)
      console.log(roledebut)
      roledebut.Etat = true;
      roledebut.BI = 'i'
      this.userRole = []
