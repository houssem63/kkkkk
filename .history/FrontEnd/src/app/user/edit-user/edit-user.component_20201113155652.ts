...
if (this.route.snapshot.paramMap.get('id') || this.IDuser !== undefined) {
  ...
  this.userID = this.route.snapshot.paramMap.get('id') || this.IDuser;
  this.mode ='edit';
...
if (this.route.snapshot.paramMap.get('role') !== null&&this.route.snapshot.paramMap.get('role') !== 'null'){
  ...
  this.changeform('initFormSociete','Société')
}
...
/*if (this.route.snapshot.paramMap.get('role') !== 'null') {
  this.Userfunction = this.route.snapshot.paramMap.get('role');
  if (this.route.snapshot.paramMap.get('role') === 'Personnel') {
    console.log(this.route.snapshot.paramMap.get('role') === 'Personnel')
