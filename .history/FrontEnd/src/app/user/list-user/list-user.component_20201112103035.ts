...
export class ListUserComponent implements OnInit {
 ...
 /* popoverTitle = ConfirmationPopover.popoverTitle;
  ...
  constructor(private userservice: UserService,
              private dialog: MatDialog, private loginservice: LoginService ,private route: ActivatedRoute) { }
  users: User[] = [];
  ngOnInit(): void {
    ...
    if(this.route.snapshot.data.role){
     this.userservice.getusershasrole(this.societeID,this.route.snapshot.data.role)
      }
  }
