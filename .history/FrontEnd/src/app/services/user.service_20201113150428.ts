...
export class UserService {
        ...
        this.http
            ...
            .subscribe((res) => {
                ...
                if (res.ok === true) {
                    ...
                    } else { this.route.navigate(['/connexion']); }
                ...
                if (res.ok === true) {
                    if (this.loginservice.isadmin) {
                        ...
                        if (this.loginservice.userhasrole(role, 'Société') || this.loginservice.userhasrole(role, 'Personnel')) {
                            this.route.navigate(['/utilisateur/personnel']);
                        } else {
            ...
            .subscribe((res) => {
                ...
                if (res.ok === true) {
                    ...
                    if (this.loginservice.isadmin) {
                        ...
                        const role = JSON.parse(localStorage.getItem('user')).roles;
                        if (this.loginservice.userhasrole(role, 'Société') || this.loginservice.userhasrole(role, 'Personnel')) {
                            this.route.navigate(['/utilisateur/client']);
                        } else {
   ...
   return   this.http.get<{users:User[]}>(BACKEND_URL+`getusershasrole/${IDsociete}/${role}`)
    }
}
